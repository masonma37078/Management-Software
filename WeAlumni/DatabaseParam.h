...
#define CREATE_ADMIN_TBL "CREATE TABLE IF NOT EXISTS Admin ( Username INT NOT NULL UNIQUE, Password INT, Email INT NOT NULL UNIQUE, Auth INT NOT NULL );"
...
#define CREATE_TREASURY_TBL "CREATE TABLE IF NOT EXISTS Treasury ( Id TEXT PRIMARY KEY, StfId TEXT NOT NULL, Type TEXT, Amount INT, Comment TEXT );"
