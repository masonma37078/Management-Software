...
#define CREATE_STAFF_TBL "CREATE TABLE IF NOT EXISTS Staff ( Id INT PRIMARY KEY, MemId INT, Dept TEXT, Position TEXT, Auth TEXT, FOREIGN KEY(MemId) REFERENCES Member(Id) );"
#define CREATE_RECORD_TBL "CREATE TABLE IF NOT EXISTS Record ( Id INT PRIMARY KEY, StfId INT, MemId INT, Time TEXT, Action TEXT, FOREIGN KEY(MemId) REFERENCES Member(Id), FOREIGN KEY(StfId) REFERENCES Staff(Id) );"
#define CREATE_OPT_TBL "CREATE TABLE IF NOT EXISTS OPT( Id INT PRIMARY KEY, Status TEXT, MemId INT, StfId INT, StartDate TEXT, EndDate TEXT, Title TEXT, Position TEXT, CardNumber TEXT, CardStartDate TEXT, CardEndDate TEXT, FOREIGN KEY(MemId) REFERENCES Member(Id), FOREIGN KEY(StfId) REFERENCES Staff(Id) );"
#define CREATE_LOG_TBL "CREATE TABLE IF NOT EXISTS Log ( Id INT PRIMARY KEY, Time TEXT, StfId INT, Action TEXT, FOREIGN KEY(StfId) REFERENCES Staff(Id) );"
#define CREATE_ITEM_TBL "CREATE TABLE IF NOT EXISTS Item ( Id INT PRIMARY KEY, Status TEXT, Name TEXT, Comment TEXT, Price TEXT );"
#define CREATE_ORDERS_TBL "CREATE TABLE IF NOT EXISTS Orders( Id INT PRIMARY KEY, Status TEXT, Time TEXT, MemId INT, StfId INT, ItemId TEXT, Amount INT, Price TEXT, Comment TEXT, FOREIGN KEY(MemId) REFERENCES Member(Id), FOREIGN KEY(StfId) REFERENCES Staff(Id), FOREIGN KEY(ItemId) REFERENCES Item(Id));"
